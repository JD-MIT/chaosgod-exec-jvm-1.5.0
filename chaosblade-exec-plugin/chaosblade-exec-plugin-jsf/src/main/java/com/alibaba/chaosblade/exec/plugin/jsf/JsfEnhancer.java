...
public abstract class JsfEnhancer extends BeforeEnhancer {
    ...
    public static List<String> JSF_SERVICE_WHITELIST;

    static {
        JSF_SERVICE_WHITELIST = new ArrayList<String>();
        JSF_SERVICE_WHITELIST.add("com.jd.jsf.service.RegistryService");
        JSF_SERVICE_WHITELIST.add("com.jd.jsf.gd.monitor.JSFMonitorService");
    }
    ...
    public EnhancerModel doBeforeAdvice(ClassLoader classLoader,
        ...
        String serviceName = ReflectUtil.invokeMethod(invocation, GET_SERVICE_NAME, new Object[0], false);
        String alias = ReflectUtil.invokeMethod(invocation, GET_ALIAS, new Object[0], false);

        if (JSF_SERVICE_WHITELIST.contains(serviceName)) {
            return null;
        }
     ...
     */
    protected abstract TimeoutExecutor createTimeoutExecutor(ClassLoader classLoader, long timeout, String className);
